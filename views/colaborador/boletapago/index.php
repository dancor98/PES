                            ...
                            <div class="row  botones-acciones">
                                <div class="col-12 col-md-auto mb-2 mb-md-0">
                                    <div class="boton-acciones">
                                        <a href="/../<?php echo $boletapago->archivo_pdf; ?>" download="Boleta Incapacidad <?php echo $boletapago->colaborador->nombre . ' ' . $boletapago->colaborador->apellido_paterno . '-' . $boletapago->fecha; ?>" class="boton-acciones__texto">
