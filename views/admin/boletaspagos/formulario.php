<input type="hidden" class="form-control formulario__input" name="colaborador_id" id="colaborador_id" value="<?php echo $_GET['id']; ?>" readonly>
<input type="hidden" class="form-control formulario__input" name="empresa_id" id="empresa_id" value="<?php echo $empresa_id; ?>" readonly>

<div class="row">
    <div class="col">
        <label for="fecha" class="formulario__label">Fecha Creacion:</label>
        <input type="text" class="form-control formulario__input" name="fecha" id="fecha" value="<?php echo date('Y-m-d'); ?>" readonly>
    </div>
    <div class="col">
        <label for="empresa" class="formulario__label">Empresa:</label>
        <input type="text" class="form-control formulario__input" name="empresa" id="empresa" value="<?php echo $empresa_nombre; ?>" readonly>
    </div>
</div>
<div class="row">
    <div class="col">
...
<fieldset class="formulario__fieldset-boleta">
    ...
    <div class="row row-campo">
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" value="<?php echo $nombre_colaborador; ?>" readonly>
        </div>
        <div class="col">
    ...
    <div class="row row-campo">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" value="<?php echo $correo_electronico; ?>" readonly>
        </div>
    </div>
</fieldset>
...
<fieldset class="formulario__fieldset-boleta">
    ...
    <div class="row row-campo">
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" value="<?php echo number_format($salario ?? 0, 2, '.', ','); ?>" id="salario" readonly>
        </div>
        <div class="col">
            <label for="quincena" class="formulario__label">Quincenal:</label>
            <input type="text" class="form-control formulario__input" name="salario_quincenal" id="salario_quincenal" value="<?php echo number_format($salario / 2.0, 2, '.', ','); ?>" readonly>
        </div>
    </div>
    <div class="row row-campo">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" name="comisiones" id="comisiones" value="<?php echo number_format($boletapago->comisiones ?? 0, 2, '.', ','); ?>" onchange="calcularTotalDevengado()">
        </div>
        <div class="col">
            <label for="feriados" class="formulario__label">Feriados:</label>
            <input type="text" class="form-control formulario__input" name="feriados" id="feriados" value="<?php echo number_format($boletapago->feriados ?? 0, 2, '.', ','); ?>" onchange="calcularTotalDevengado()">
        </div>
    </div>
    <div class="row row-campo">
        <div class="col">
            <label for="total_devengado" class="formulario__label">Total Devengado:</label>
            <input type="text" class="form-control formulario__input" name="total_devengado" id="total_devengado" value="<?php echo number_format($boletapago->total_devengado, 2, '.', ','); ?>" readonly>
        </div>
    </div>
</fieldset>
...
<fieldset class="formulario__fieldset-boleta">
    ...
    <div class="row row-campo">
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" name="impuestos_renta" id="impuestos_renta" value="0.00" onchange="calcularTotalDeducciones()">
        </div>
        <div class="col">
            <label for="incapacidades" class="formulario__label">Incapacidades:</label>
            <input type="text" class="form-control formulario__input" name="incapacidades" id="incapacidades" value="<?php echo number_format($boletapago->incapacidades ?? 0, 2, '.', ','); ?>" onchange="calcularTotalDeducciones()">
        </div>
    </div>
    ...
    <div class="row row-campo">
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" name="otras_deducciones" id="otras_deducciones" value="<?php echo number_format($boletapago->otras_deducciones ?? 0, 2, '.', ','); ?>" onchange="calcularTotalDeducciones()">
        </div>
        <div class="col">
            <label for="embargo" class="formulario__label">Embargo:</label>
            <input type="text" class="form-control formulario__input" name="embargo" id="embargo" value="<?php echo number_format($boletapago->embargo ?? 0, 2, '.', ','); ?>" onchange="calcularTotalDeducciones()">
        </div>
    </div>
    <div class="row row-campo">
        <div class="col">
            <label for="total_deducciones" class="formulario__label">Total Deducciones:</label>
            <input type="text" class="form-control formulario__input" name="total_deducciones" id="total_deducciones" value="0.00" readonly>
        </div>
    </div>
</fieldset>
...
<fieldset class="formulario__fieldset-boleta">
    ...
    <div class="row row-campo">
        <div class="col">
            ...
            <input type="text" class="form-control formulario__input" name="primer_quincena" id="primer_quincena" value="0.00" readonly>
        </div>
        <div class="col">
            <label for="segunda_quincena" class="formulario__label">Segunda Quincena:</label>
            <input type="text" class="form-control formulario__input" name="segunda_quincena" id="segunda_quincena" value="0.00" readonly>
        </div>
    </div>
</fieldset>
...
<script>
    ...
    function calcularTotalDevengado() {
        ...
        var total = salario + comisiones + feriados;
    ...
    function calcularTotalDeducciones() {
        ...
        var totalDeducciones = ccss + impuesto_renta + otrasDeducciones + embargo + incapacidades;
