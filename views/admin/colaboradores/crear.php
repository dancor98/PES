...
<div class="contenedor-formulario">
    ...
    <form method="POST" action="/admin/colaboradores/crear" enctype="multipart/form-data" class="formulario" id="FormularioInterno">
        ...
        <fieldset class="formulario__fieldset">
            ...
            <div class="formulario__campo">
                <input type="text" class="formulario__input" name="contrasena" id="contrasena" value="1234567CCM" hidden>
            </div>

            <input class="formulario__submit formulario__submit--registrar" type="submit" value="Registrar Colaborador" id="botonSubmit">
    </form>
