<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="number" class="formulario__input" name="cedula" id="cedula" placeholder="cedula colaborador"
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" name="nombre_emergencia" id="nombre_emergencia"
            placeholder="Nombre Contacto de Emergencia" value="<?php echo $colaborador->nombre_emergencia ?? ''; ?>">
    </div>
    ...
    <div class="formulario__campo">
        ...
        <input type="tel" class="formulario__input" name="telefono_emergencia" id="telefono_emergencia"
            placeholder="Telefono Contacto Emergencia" value="<?php echo $colaborador->telefono_emergencia ?? ''; ?>">
    </div>
</fieldset>
