...
<div class="contenedor espacio" id="productos">
    ...
    <div class="principal-container">
        <div class="columna1">
            <h2 class="subtitulo-inicio">RETUL</h2>
        ...
        <div class="columna2">
            <img class="img-servicios img-servicios__1" src="build/img/retul.png" alt="">
        </div>
    </div>
    <br>
    <div class="principal-container">
    ...
    <br>
    <h1 class="titulo-inicio titulo-inicio--3">eventos</h1>
    <div class="principal-container">
        <div class="columna1">
