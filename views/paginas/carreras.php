        ...
        <fieldset class="formulario__fieldset">
            ...
            <div class="row row-campo">
                <div class="col">
                    ...
                    <input type="text" name="fecha_postulacion" id="fecha_postulacion"
                        class="form-control formulario__input" value="<?php echo date('Y-d-m'); ?>" readonly>
                </div>
            </div>
            <div class="row row-campo">
                <div class="col">
                    <label for="nombre" class="formulario__label">Nombre:</label>
                    <input type="text" name="nombre" id="nombre" class="form-control formulario__input"
                        value="<?php echo $carrera->nombre; ?>" placeholder="Ingresa tu nombre" require>
                </div>
                <div class="col">
                    <label for="apellido_paterno" class="formulario__label">Apellido:</label>
                    <input type="text" name="apellido_paterno" id="apellido_paterno"
                        class="form-control formulario__input" value="<?php echo $carrera->apellido_paterno; ?>"
                        placeholder="Ingresa tu primer Apellido" require>
                </div>
                <div class="col">
                    <label for="apellido_materno" class="formulario__label">Apellido:</label>
                    <input type="text" name="apellido_materno" id="apellido_materno"
                        class="form-control formulario__input" value="<?php echo $carrera->apellido_materno; ?>"
                        placeholder="Ingresa tu segundo apellido" require>
                </div>
            </div>
            <div class="row row-campo">
                <div class="col">
                    <label for="cedula" class="formulario__label">Cedula:</label>
                    <input type="number" name="cedula" id="cedula" class="form-control formulario__input"
                        value="<?php echo $carrera->cedula; ?>" placeholder="Ingresa tu cedula" require>
                </div>
                <div class="col">
                    <label for="fecha_nacimiento" class="formulario__label">Fecha Nacimiento:</label>
                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento"
                        class="form-control formulario__input" value="<?php echo $carrera->fecha_nacimiento; ?>"
                        require>
                </div>
                <div class="col">
            ...
            <div class="row row-campo">
                <div class="col">
                    ...
                    <input type="tel" name="telefono" id="telefono" class="form-control formulario__input"
                        value="<?php echo $carrera->telefono; ?>" placeholder="Ingresa tu telefono" require>
                </div>
                <div class="col">
                    <label for="correo" class="formulario__label">Correo Electronico:</label>
                    <input type="email" name="correo" id="correo" class="form-control formulario__input"
                        value="<?php echo $carrera->correo; ?>" placeholder="Ingresa tu correo electronico" require>
                </div>
            </div>
            ...
            <div class="row row-campo">
                <div class="col">
                    ...
                    <select class="form-control formulario__input" id="departamento" name="departamento_id">
                        ...
                        <option <?php echo ($carrera->departamento_id === $departamento->id) ? 'selected' : '' ?>
                ...
                <div class="col">
                    ...
                    <input type="number" name="pretencion_salarial" id="pretencion_salarial"
                        class="form-control formulario__input" value="<?php echo $carrera->pretencion_salarial; ?>"
                        placeholder="Ingresa tu pretencion salarial" require>
                </div>
            </div>

            <div class="formulario__campo">
                <label for="mensaje" class="formulario__label">Mensaje para el reclutador:</label>
                <textarea class="formulario__textarea" name="mensaje" id="mensaje"
                    require><?php echo $carrera->mensaje; ?></textarea>
            </div>
