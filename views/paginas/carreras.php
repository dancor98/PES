        ...
        <fieldset class="formulario__fieldset">
            ...
            <div class="row row-campo">
                <div class="col">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control formulario__input" value="<?php echo $carrera->nombre; ?>" placeholder="Ingresa tu nombre">
                </div>
                <div class="col">
                    <label for="apellido_paterno" class="formulario__label">Apellido:</label>
                    <input type="text" name="apellido_paterno" id="apellido_paterno" class="form-control formulario__input" value="<?php echo $carrera->apellido_paterno; ?>" placeholder="Ingresa tu primer Apellido">
                </div>
                <div class="col">
                    <label for="apellido_materno" class="formulario__label">Apellido:</label>
                    <input type="text" name="apellido_materno" id="apellido_materno" class="form-control formulario__input" value="<?php echo $carrera->apellido_materno; ?>" placeholder="Ingresa tu segundo apellido">
                </div>
            </div>
            <div class="row row-campo">
                <div class="col">
                    <label for="cedula" class="formulario__label">Cedula:</label>
                    <input type="number" name="cedula" id="cedula" class="form-control formulario__input" value="<?php echo $carrera->cedula; ?>" placeholder="Ingresa tu cedula">
                </div>
                <div class="col">
                    <label for="fecha_nacimiento" class="formulario__label">Fecha Nacimiento:</label>
                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control formulario__input" value="<?php echo $carrera->fecha_nacimiento; ?>">
                </div>
                <div class="col">
            ...
            <div class="row row-campo">
                <div class="col">
                    ...
                    <input type="tel" name="telefono" id="telefono" class="form-control formulario__input" value="<?php echo $carrera->telefono; ?>" placeholder="Ingresa tu telefono">
                </div>
                <div class="col">
                    <label for="correo" class="formulario__label">Correo Electronico:</label>
                    <input type="email" name="correo" id="correo" class="form-control formulario__input" value="<?php echo $carrera->correo; ?>" placeholder="Ingresa tu correo electronico">
                </div>
            </div>
            ...
            <div class="row row-campo">
                ...
                <div class="col">
                    ...
                    <input type="number" name="pretencion_salarial" id="pretencion_salarial" class="form-control formulario__input" value="<?php echo $carrera->pretencion_salarial; ?>" placeholder="Ingresa tu pretencion salarial">
                </div>
            </div>

            <div class="formulario__campo">
                <label for="mensaje" class="formulario__label">Mensaje para el reclutador:</label>
                <textarea class="formulario__textarea" name="mensaje" id="mensaje"> <?php echo $carrera->mensaje; ?> </textarea>
            </div>


            <div class="formulario__campo">
                <label for="cv" class="formulario__label">Cargar CV:</label>
                <input type="file" class="formulario__input" name="cv" id="cv" accept="application/pdf">
